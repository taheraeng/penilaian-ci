...
<head> 
    ...
    <title>Top IOT & Product Design</title>
...
<body>
   ...
   <div class="container-fluid">
    ...
    <br />
        ...
        <br />
        <br />
        <h1 class="big" style="text-align: center">Top IOT & Product Design</h1>
                    ...
                    <th>Phone</th>
                      ...
                      <tbody>  
                        ...
                        <tr>
                            ...
                            <td><button diu="<?=$user['idscreen'];?>" ganti="<?php echo $users['id']; ?>" class="statusdoang btn <?php echo ($users['tiga'])? 'btn-success' : 'btn-danger'?>"><?php echo ($users['tiga'])? 'Top 30' : 'Goes Top 30'?></button></td> </tr>
                            <?php $i++; } ?>
                        </tbody>
                    </table>
                </div>
