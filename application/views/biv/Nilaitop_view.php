                    ...
                    <tbody>  
                        ...
                        <tr> 
                          ...
                          <td> <?php echo  $users['xnilai'] ; ?></td>
                            ...
                            <?php endif; ?>
                          <?php if($user['level'] == '3' || $user['level'] == '5'): ?>
                              <td><a class="btn btn-md btn-danger" <?php if($user['level'] = '5') { echo 'data-screener="' . $users["idscreener"] . '"'; } ?> href="javascript:void(0)" title="Edit" onclick="edit_person('<?php echo  $users['id'] ; ?>')">Nilai</a></td>
                          <?php endif; ?>
                          </tr>    
                          <?php $i++; } ?>
                      </tbody>
              ...
              /*  table = $('#table').DataTable({
                ...
                */
                ...
                $('#form').submit(function (e) {
                    ...
                    e.preventDefault();
                    $.ajax({
                        url: "<?php echo site_url('nilaitop_contr/save') ?>",
                        type: 'POST',
                        data: $('#form').serialize(),
                ...
                $.ajax({
                    ...
                    success: function (data)
                    {
                        ...
                        if(data.ideafile!=null){
                            if(data.ideafile.includes("jpg") || data.ideafile.includes("jpeg") || data.ideafile.includes("gif") || data.ideafile.includes("png")){
