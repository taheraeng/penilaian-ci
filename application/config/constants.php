 ...
 *
 */
defined('DEF_CONST')        OR define('DEF_CONST', 0);
defined('ASSETS')           OR define('ASSETS', "assets/");

/** WEBSOCKETS BROADCAST TYPES **/
defined('POST')             OR define('POST', "post");
defined('BROADCAST_URL')    OR define('BROADCAST_URL', "202.158.39.170");
defined('BROADCAST_PORT')   OR define('BROADCAST_PORT', "2000");
