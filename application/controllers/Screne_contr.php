...
class Screne_contr extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->model('Screne_mdl', 'screne_contr');
    ...
    public function index() {
        ...
        if ($session == TRUE) {
            ...
            $data['userss'] = $this->screne_contr->getalluser($idscreen);
            $data['xnilai'] = $this->screne_contr->ratarata();
            $this->load->view('biv/Screne_view', $data);
        } else {
            redirect('depan');
        }
    }
   ...
   public function ajax_edit($idrelation) {
        $data = $this->screne_contr->ambilin($idrelation);
